...
public class MostrarActivityBebidasEmbotellados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = mFirestore.collection("bebidas").whereEqualTo("tipoBebida","Embotellado");
